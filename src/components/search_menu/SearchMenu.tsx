      ...
      >
        <div>
          ...
          <div className="rounded-2xl overflow-hidden grid custom-shadow lg:grid-cols-3">
            <div
              className={`flex flex-col px-6 py-3 border-b-[1px] lg:border-0 lg:border-r-[1px] cursor-pointer rounded-l-2xl ${
            ...
            <div
              className={`flex flex-col px-6 py-3 lg:border-r-[1px] cursor-pointer ${
